...
import static ch.vaudoise.crm_api.config.mongo.MongoOffsetDateTimeWriter.DATE_FIELD;
import static ch.vaudoise.crm_api.config.mongo.MongoOffsetDateTimeWriter.OFFSET_FIELD;
